...
if __name__ == '__main__':
    ...
    if dataset in ['davis', 'BindingDB', 'celegans', 'kiba', 'DrugBank', 'BIOSNAP','data']:
        proteins_file = os.path.join(f'proteins_{dataset}')
        if not os.path.exists(proteins_file):
            proteins = {}
            data_file = os.path.join(f'/home/severus/code/three/CoAff-DTI-main/data/{dataset}.txt')
            seq_list = []
            count = 1
